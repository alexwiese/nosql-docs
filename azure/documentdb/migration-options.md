...
Create and manage your migration jobs in **Visual Studio Code** by using [Azure DocumentDB Migration Extension](./how-to-migrate-vs-code-extension.md). This solution is designed for **simplicity**, **security**, and **zero downtime**.
