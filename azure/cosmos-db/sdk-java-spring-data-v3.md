---
title: Spring Data V3 for API for Nosql Release Notes and Resources
...
| **Get started** | [GitHub repo with quickstart code](https://github.com/Azure-Samples/azure-spring-data-cosmos-java-sql-api-getting-started) | 
| **Basic code samples** | [GitHub repo with sample code](https://github.com/Azure-Samples/azure-spring-data-cosmos-java-sql-api-samples)|
...
It's strongly recommended to upgrade to [Azure Spring Data Azure Cosmos DB v5](sdk-java-spring-data-v5.md) and use the [minimum recommended version](sdk-java-spring-data-v5.md#recommended-version) and above.
