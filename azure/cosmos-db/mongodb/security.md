...
description: Review the fundamentals of securing Azure Cosmos DB for MongoDB from the perspective of data and networking security.
author: seesharprun
...
# Secure your Azure Cosmos DB for MongoDB account

Azure Cosmos DB for MongoDB is a fully managed NoSQL database service that you can use to store, manage, and query large volumes of key/value data by using the familiar Azure MongoDB storage APIs. Although Azure Cosmos DB provides built-in security features to protect your data, it's essential to follow best practices to further enhance the security of your account, data, and networking configurations.

This article provides guidance on how to best secure your Azure Cosmos DB for MongoDB deployment.
...
- **Use Always Encrypted to secure data with client-side encryption:** Ensure that sensitive data is encrypted on the client side before being sent to Azure Cosmos DB. Use Always Encrypted for an extra layer of security. For more information, see [Always Encrypted](../how-to-always-encrypted.md).
