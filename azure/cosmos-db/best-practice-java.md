...
| <input type="checkbox"/>  |   End-to-End Timeouts | To get end-to-end timeouts, implement [end-to-end timeout policy in the Java SDK](troubleshoot-java-sdk-request-time-out.md#end-to-end-time-out-policy). For more details on timeouts with Azure Cosmos DB [visit here](troubleshoot-java-sdk-request-time-out.md) |
